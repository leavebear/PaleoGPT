    ...
    <div class="home-page">
        <header class="header">
            <div class="header-left">
                <!-- <img src="@/assets/photo/paleo-gpt-logo.png" alt="Paleo GPT Logo" class="logo-image">
                <span class="logo-text">PaleoGpt Chat</span> -->
            </div>
        ...
        <main class="main-content">
            <div class="hero-section">
                <h1 class="title">欢迎使用 PaleoGpt Chat</h1>
...
@font-face {
    ...
    src: url("//at.alicdn.com/wf/webfont/BJzY442fthaR/a2svAS80eBge.woff2") format("woff2"),
        url("//at.alicdn.com/wf/webfont/BJzY442fthaR/Q31HBDiVMMNh.woff") format("woff");
    font-display: swap;
}
...
.home-page {
    ...
    // background-image: url('src/assets/photo/生成特定背景图.png');
}
...
.header {
    ...
    //background-color: rgb(123, 161, 231);
